...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	methods := map[string]kitex.MethodInfo{
		"GetNewsByTitle":     kitex.NewMethodInfo(getNewsByTitleHandler, newYimaNewsGetNewsByTitleArgs, newYimaNewsGetNewsByTitleResult, false),
		"AddNews":            kitex.NewMethodInfo(addNewsHandler, newYimaNewsAddNewsArgs, newYimaNewsAddNewsResult, false),
		"GetAllNewsByUserId": kitex.NewMethodInfo(getAllNewsByUserIdHandler, newYimaNewsGetAllNewsByUserIdArgs, newYimaNewsGetAllNewsByUserIdResult, false),
	}
